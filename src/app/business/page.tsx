...
const translations = {
  fr: {
    ...
    social_stats: [
      { number: "3 500+", label: "missions planifiées" },
      { number: "4.9★", label: "note moyenne" },
      { number: "97%", label: "de satisfaction" },
      { number: "+80", label: "villes couvertes" },
    ],
  ...
  en: {
    ...
    social_stats: [
      { number: "3,500+", label: "missions planned" },
...
export default function BusinessPage() {
  ...
  return (
    <div className="min-h-screen" style={{ color: B.faint, fontFamily: "var(--font-dm-sans), system-ui, sans-serif", background: B.bg }}>
      ...
      {/* LAUNCH BANNER */}
      <div
        className="fixed top-0 w-full z-[60] overflow-hidden h-12 flex items-center justify-center cursor-default"
