...
const translations = {
  fr: {
    banner_messages: [
      ...
      "Guides professionnels sur mesure · Livraison sous 24h",
      "🏷️ -25% sur votre premier guide avec le code WELCOME",
    ...
    how_steps: [
      ...
      },
      {
        ...
        desc: "PDF professionnel livré sous 24h dans votre boîte mail. Prêt à partir en déplacement.",
      },
    ],
  ...
  en: {
    banner_messages: [
      ...
      "Tailor-made professional guides · Delivered within 24h",
      "🏷️ -25% on your first guide with code WELCOME",
    ...
    how_steps: [
      ...
      },
      {
        ...
        desc: "Professional PDF delivered to your inbox within 24h. Ready to travel.",
      },
    ],
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="mb-5 w-12 h-12 rounded-lg flex items-center justify-center" style={{ background: "rgba(59,130,246,0.15)", border: "1px solid rgba(59,130,246,0.3)" }}>
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2"/></svg>
                </div>
          ...
          <div className="rounded-2xl p-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6" style={{ background: B.card, border: `1px solid ${B.border}` }}>
            <div className="flex-1">
              ...
              <ul className="space-y-1.5 text-sm" style={{ color: B.muted }}>
                {(lang === "fr"
                  ? ["Programme mission jour par jour jusqu'à 7 jours","Hôtels business, restaurants clients","Transports & agenda optimisés","Livraison PDF sous 24h"]
                  : ["Mission schedule day-by-day up to 7 days","Business hotels, client restaurants","Optimised transport & agenda","PDF delivery within 24h"]
                ).map(f => (
                  <li key={f} className="flex items-center gap-2">
                    <span className="font-bold text-xs" style={{ color: B.accent }}>✓</span>{f}
                  </li>
