...
function BusinessCalendar({ startDate, endDate, onChange, error, maxDays }: {
  startDate: string; endDate: string;
  onChange: (s: string, e: string) => void;
  error?: string; maxDays?: number;
}) {
  ...
  function select(key: string) {
    ...
    if (maxDays && countDays(startDate, key) > maxDays) {
      setCalErr(`Ce forfait est limité à ${maxDays} jours.`); return;
    }
